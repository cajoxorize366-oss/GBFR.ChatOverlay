...
public sealed class VoiceOverlayPresenterTests
{
    ...
    [InlineData((int)PartyVoiceUiState.WaitingForPeer, true, "F10 设置 / 本地自检")]
    [InlineData((int)PartyVoiceUiState.LocalSelfTesting, true, "本地自检中")]
    ...
    [InlineData((int)PartyVoiceUiState.Ready, true, "U 队友通话 / F10 设置与自检")]
