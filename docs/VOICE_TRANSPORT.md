...
- The external voice test is implemented and enabled by default in `0.3.0-preview.6`. Every participant must install the same package; a vanilla peer has no remote ChatControl and is not granted voice permissions.
