...
- [NAudio](https://github.com/naudio/NAudio) (`NAudio.Wasapi` and `NAudio.Core` 2.3.0), under the MIT license, supplies the shared-mode Windows audio capture and playback path used only by the settings-page local microphone self-test. The license is reproduced at `licenses/NAudio-LICENSE.txt`.
