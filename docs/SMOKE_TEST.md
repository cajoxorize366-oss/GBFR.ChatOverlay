...
5. Verify the native party-HUD whitelist: while the HP HUD is visible the icons are present; opening Relink's main menu, entering the battle-results screen, or reaching any other screen without the party HP HUD must remove every icon. Returning to a visible party HP HUD must restore them automatically.
