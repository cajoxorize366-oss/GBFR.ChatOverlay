...
Version 0.7.2 is a maintenance release that improves automatic communication delivery in official chat history and stabilizes IME and chat-history focus behavior. Development handoff notes and preview-only scaffolding are not shipped.
...
3. Extract `GBFR.ChatOverlay-0.7.2-Relink-2.0.4.zip` into `Reloaded-II/Mods`.
...
./ci/package-chat.ps1 -Version 0.7.2
```
