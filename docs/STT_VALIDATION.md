...
artifacts\validation\GBFR.ChatOverlay-0.2.0-stt-base.zip
```
...
3. Confirm the log contains `STT worker ready; Whisper base model hash verified.`
...
5. Confirm recognized Chinese, Japanese or English appears in the editable draft. Correct it if necessary and press Enter.
