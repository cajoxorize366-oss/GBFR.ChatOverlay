...
5. While the battle HUD is visible, open Relink's main menu. Every microphone icon must disappear for the complete menu lifetime—even over translucent menu regions—and must return automatically after closing the menu.
